...
@else
    <form action="{{ url('/kegiatanjti/' . $laporan->kegiatan_id. '/update_laporan') }}" method="POST" id="form-edit" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="custom-file">
                        <input type="file" name="laporan" id="laporan" class="custom-file-input" accept=".pdf" required>
                        <label class="custom-file-label" for="laporan">Pilih File Laporan</label>
                    </div>
                    <small id="error-laporan" class="error-text form-text text-danger"></small>
                    <small class="form-text text-muted">Unggah file laporan dalam format PDF. Maksimal 2MB.</small>
                </div>
            </div>
